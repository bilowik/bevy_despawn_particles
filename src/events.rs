...
#[derive(Clone)]
pub struct DespawnParticlesPresetBuilder {
    pub angvel: Property<f32>,
    pub linvel: Property<f32>,
    pub linvel_addtl: Property<Vec2>,
    pub linear_damping: Property<f32>,
...
impl DespawnParticlesPreset {
    pub fn builder() -> DespawnParticlesPresetBuilder {
        DespawnParticlesPresetBuilder::new()
    }
}

impl DespawnParticlesPresetBuilder {
    pub fn new() -> Self {
        Self {
            angvel: Default::default(),
            linvel: Default::default(),
    ...
    pub fn build(self) -> DespawnParticlesPreset {
        DespawnParticlesPreset {
            angvel: self.angvel,
            linvel: self.linvel,
            linvel_addtl: self.linvel_addtl,
            linear_damping: self.linear_damping,
